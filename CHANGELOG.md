...
- Installer validation now renders the ReproSec banner at most once: `doctor` remains user-visible while internal capability/help smokes run with `SENTINEL_BANNER=off`.
