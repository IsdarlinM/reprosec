...
"%VENV%\Scripts\python.exe" -m pip install --upgrade -c "%CONSTRAINTS%" "%REPO_ROOT%" || (echo Installation failed. ReproSec requires sric-core 0.5.x and resolves it automatically.& exit /b 3)
