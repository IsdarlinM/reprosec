...
def artifact(artifact_id: str, content: bytes, references: list[str] | None = None) -> dict[str, object]:
    return {
...
def snapshot(capsule_id: str, artifacts: list[dict[str, object]]) -> dict[str, object]:
